...
import { dungeonRouter } from "./controllers/dungeonController";
...
app.use(`/api/${API_VERSION}/dungeons`, dungeonRouter);
...
const startServer = async () => {
	try {
		...
		const server = app.listen(PORT, () => {
			console.log(`[DungeonsService] Démarré sur le port ${PORT}`);
		});
